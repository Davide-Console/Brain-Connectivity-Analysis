function regions_array = INTtoREGION(nodes_array)
...
values = {'Precentral_L', 'Precentral_R', 'Frontal_Sup_L', 'Frontal_Sup_R', 'Frontal_Sup_Orb_L', 
    ...
    'Olfactory_L', 'Olfactory_R', 'Frontal_Sup_Medial_L', 'Frontal_Sup_Medial_R', 'Frontal_Mid_Orb_L (Med)', 
    'Frontal_Mid_Orb_R (Med)', 'Rectus_L', 'Rectus_R', 'Insula_L', 'Insula_R', 
...
for i = 1:90
        regions_array(i, 1) = dictionary(uint8(nodes_array(i, 1)));
end
